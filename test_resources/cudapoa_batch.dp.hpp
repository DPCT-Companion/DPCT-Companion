...
public:
    ...
    void generate_poa()
    {
        ...
        /*
        DPCT1003:140: Migrated API does not return error code. (*, 0) is
        ...
        */
        GW_CU_CHECK_ERR(
            (stream_->memcpy(output_details_h_->consensus,
             ...
             0));
        /*
        DPCT1003:145: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
                       ...
                       std::vector<StatusType>& output_status)
    {
        ...
        /*
        DPCT1003:147: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
            (stream_->memcpy(
        ...
        /*
        DPCT1003:148: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
            (stream_->memcpy(output_details_h_->consensus,
        ...
        /*
        DPCT1003:149: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR((stream_->wait(), 0));
                    ...
                    std::vector<StatusType>& output_status)
    {
        ...
        /*
        DPCT1003:150: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
        ...
        /*
        DPCT1003:151: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
        ...
        /*
        DPCT1003:152: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
        ...
        /*
        DPCT1003:153: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
        ...
        /*
        DPCT1003:154: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
